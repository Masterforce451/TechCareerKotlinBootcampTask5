...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resultButton.setOnClickListener {
            ...
            if (!sayilar.contains("")) {
                ...
                Snackbar.make(it, "Lütfen işlem için sayı giriniz.", Snackbar.LENGTH_SHORT).show()
            }
        }
    ...
    fun throwNotImplemented(view: View) {
        Snackbar.make(view, "Bu işlem henüz geliştirme aşamasında.", Snackbar.LENGTH_SHORT).show()
    }
}